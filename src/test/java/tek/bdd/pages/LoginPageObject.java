...
public class LoginPageObject {
    ...
    public static final By SIGN_IN_TO_YOUR_ACCOUNT_TEXT = By.xpath
            ("//h2[normalize-space()='Sign in to your Account']");
    ...
    public static final By VALIDATE_CUSTOMER_SERVICES_PORTAL = By.xpath
            ("//h2[text()='Customer Service Portal']");
